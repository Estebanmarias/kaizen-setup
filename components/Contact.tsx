...
const inputClass =
  "w-full px-4 py-3 rounded-lg border border-gray-200 bg-white text-gray-900 text-sm focus:outline-none focus:border-blue-500 transition-colors";
  ...
  return (
    <section id="contact" className="py-20 px-6 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        <p className="text-xs font-semibold tracking-widest uppercase text-blue-500 mb-3">Get In Touch</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div className="flex flex-col gap-4">
            {success ? (
              <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 text-blue-700 font-medium">
          ...
          <div className="flex flex-col gap-6">
            ...
            <a href="https://wa.me/2349064811857" target="_blank" rel="noopener noreferrer"
              className="group flex items-center gap-3 bg-gray-900 text-white px-5 py-3 rounded-lg font-semibold text-sm w-fit
                transition-all duration-300 hover:bg-[#25D366] hover:shadow-lg hover:shadow-[#25D366]/25 hover:scale-[1.02]">
            ...
            <a href="https://www.instagram.com/kaizensetup/" target="_blank" rel="noopener noreferrer"
              className="group relative flex items-center gap-3 px-5 py-3 rounded-lg font-semibold text-sm w-fit
                border border-gray-200 text-gray-700 overflow-hidden
                transition-all duration-300 hover:border-transparent hover:text-white hover:scale-[1.02] hover:shadow-lg hover:shadow-pink-500/25">
