        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="flex flex-col gap-6">
            ...
            <a href="https://wa.me/2347035378462" target="_blank" rel="noopener noreferrer"
              className="flex items-center gap-3 bg-gray-900 hover:bg-gray-700 text-white px-5 py-3 rounded-lg font-semibold text-sm transition-colors w-fit">
              <MessageCircle size={18} />
              Chat on WhatsApp
            </a>

            <a href="https://www.instagram.com/kaizensetup/" target="_blank" rel="noopener noreferrer"
              className="flex items-center gap-3 border border-gray-200 hover:border-blue-500 hover:text-blue-500 text-gray-700 px-5 py-3 rounded-lg font-semibold text-sm transition-colors w-fit">
              <Instagram size={18} />
              Follow on Instagram
            </a>
          </div>
