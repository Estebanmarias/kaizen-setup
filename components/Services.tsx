...
export default function Services() {
  return (
    <section id="services" className="py-20 px-6 bg-gray-50 dark:bg-[#141414]">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {SERVICES.map((s) => {
            ...
            return (
              <div key={s.title}
                className="bg-white dark:bg-[#1a1a1a] border border-gray-200 dark:border-gray-800 rounded-xl p-6 hover:border-gray-900 dark:hover:border-white transition-colors group">
