...
export default function Services() {
  return (
    <section
      id="services"
      className="py-20 px-6 bg-gray-50 dark:bg-[#141414]"
    >
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-gray-500 dark:text-gray-400 mb-12 max-w-xl">
          Every service is built around one principle: give you exactly what you
          need, nothing more.
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {SERVICES.map((s) => {
            ...
            return (
              <div
                key={s.title}
                className="bg-white dark:bg-[#1a1a1a] border border-gray-200 dark:border-gray-800 rounded-xl p-6 hover:border-emerald-500 transition-colors group"
              >
                ...
                <span className="text-xs font-semibold text-emerald-500 group-hover:underline cursor-pointer">
                  Learn More →
                </span>
              </div>
            );
