...
const SOCIALS = [
  { label: "Instagram", href: "https://www.instagram.com/kaizensetup/", icon: Instagram },
  { label: "YouTube", href: "https://www.youtube.com/@KaizenSetupng", icon: Youtube },
  {
    label: "TikTok", href: "https://www.tiktok.com/@kaizensetup",
    icon: () => (
  ...
  {
    label: "X", href: "https://x.com/kaizensetupng",
    icon: () => (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
  ...
  {
    label: "Medium", href: "https://medium.com/@kaizensetup.ng",
    icon: () => (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
