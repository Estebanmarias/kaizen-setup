...
export default function AccountPage() {
  ...
  const avatarUrl = profile?.avatar_url ?? `https://api.dicebear.com/7.x/initials/svg?seed=${encodeURIComponent(displayName ?? 'U')}&backgroundColor=3b82f6&textColor=ffffff&fontSize=40`
    ...
    <main className="min-h-screen bg-white dark:bg-[#0f0f0f] pt-24 pb-20 px-6">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-gray-50 dark:bg-[#1a1a1a] border border-gray-200 dark:border-gray-800 rounded-2xl p-6 mb-6 flex items-center gap-5">
          <img src={avatarUrl} alt={displayName ?? ''} className="w-16 h-16 rounded-full object-cover flex-shrink-0" />
